          ...
          <div className="flex flex-wrap gap-3 opacity-0 animate-fade-in [animation-delay:600ms]">
            {socialLinks.map((link) => (
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-card border border-border text-sm text-muted-foreground hover:text-foreground hover:border-foreground/30 transition-colors"
              >
